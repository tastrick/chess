...
public class GUI2 extends JFrame {
    ...
    static JPanel chess;
    static JLabel chessPiece1;
    static JLabel chessPiece2;
     JLabel chessPiece;
    int xAdjustment;
    int yAdjustment;
    int sx,sy;
...
/*
      public void mousePressed(MouseEvent e){
        ...
        x1=sx;
        y1=sy;
        //System.out.println(e.getX()+","+e.getY()+","+sx*75+","+sy*75);
...
public void movement(String s){
	...
	int l=0;
		...
		//Component test1 = chess.findComponentAt(558,113);
		//Component test3 = chess.findComponentAt(100,100);
		//Component test2 = chess.findComponentAt(1,1);
		//System.out.println(c.getX()+","+c.getY());
		//System.out.println(c2.getX()+","+c2.getY());
		//System.out.println(test2.getX()+","+test2.getY());
		//System.out.println(test1.getX()+","+test1.getY()+","+test3.getX()+","+test3.getY());
		//if (c ==null){System.out.println("islabel");}
		chessPiece1=(JLabel)c;
		//chessPiece1.setVisible(false);
		//System.out.println(i*75+","+j*75+","+k*75+","+l*75);
		Container parent = c.getParent();
		//Container parent2=c2.getParent();
		//System.out.println(parent.getX()+","+parent.getY());
		//System.out.println(parent2.getX()+","+parent2.getY());
		parent.remove(0);
    	if (c2 instanceof JLabel){
			...
			Container parent2 = (Container) c2;
			
			//chessPiece1.setLocation(k*75,l*75);
			//chess.removeAll();
			//chess.revalidate();
			//chess.repaint();
			//parent2.remove(0);
